...
class AdminManager {
    ...
    public function register_admin_menu() {
        ...
        // Hidden migration page
        add_submenu_page(
            null, // No menu item
            __('Run Price Migration', 'waza-booking'),
            __('Run Price Migration', 'waza-booking'),
            'manage_options',
            'waza-run-price-migration',
            [$this, 'run_price_migration']
        );
    }
     ...
     * Run price migration
     */
    public function run_price_migration() {
        global $wpdb;
        
        echo '<div class="wrap">';
        echo '<h1>Waza Booking - Price Fields Migration</h1>';
        echo '<div style="background: #fff; padding: 20px; margin: 20px 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">';
